...
class CourseDetailsWidget extends StatefulWidget {
  ...
  static String routePath = '/courseDetails';
                            ...
                            children: [
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'by ${valueOrDefault<String>(
                                          widget!.courseDoc?.instrutorName,
                                          'Abdi',
                                        )}',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                  ...
                                  Expanded(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '${widget!.courseDoc?.reviews?.toString()} Reviews',
                                          style: FlutterFlowTheme.of(context)
                                              .labelSmall
                                              .override(
                                                font: GoogleFonts.openSans(
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    valueOrDefault<String>(
                                      widget!.courseDoc?.description,
                                      'Master the art of building resilient, Scandinavian-inspired design systems. We cover atomic principles, tokenization, and documentation workflows used in top-tier SaaS products.',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                ...
                                children: [
                                  ...
                                  FutureBuilder<List<CourseSectionsRow>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<CourseSectionsRow>
                                          listViewCourseSectionsRowList =
                                          snapshot.data!;
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemCount: listViewCourseSectionsRowList
                                            .length,
                                        itemBuilder: (context, listViewIndex) {
                                          final listViewCourseSectionsRow =
                                              listViewCourseSectionsRowList[
                                                  listViewIndex];
                                          return SyllabusModuleWidget(
                                            key: Key(
                                                'Keyx0h_${listViewIndex}_of_${listViewCourseSectionsRowList.length}'),
                                            index: listViewCourseSectionsRow
                                                .orderIndex
                                                ?.toString(),
                                            title:
                                                listViewCourseSectionsRow.title,
                                            sectionId:
                                                listViewCourseSectionsRow.id!,
                                          );
                                        },
                                      );
                                    },
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemBuilder: (context, listViewIndex) {
                                          ...
                                          return ReviewCardWidget(
                                            key: Key(
                                                'Keylwb_${listViewIndex}_of_${listViewReviewsRowList.length}'),
                                            review: listViewReviewsRow.review,
                                            rating: listViewReviewsRow.rating!,
                                            userId: listViewReviewsRow.userId!,
                                          );
                                        },
                                      );
                                    },
