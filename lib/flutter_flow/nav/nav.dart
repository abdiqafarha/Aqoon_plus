...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'CourseCatalog')
              : CourseCatalogWidget(),
        ),
        FFRoute(
          name: LessonPlayerWidget.routeName,
          path: LessonPlayerWidget.routePath,
          builder: (context, params) => LessonPlayerWidget(
            lessonDoc: params.getParam<LessonsRow>(
              'lessonDoc',
              ParamType.SupabaseRow,
            ),
            sectionTitle: params.getParam(
              'sectionTitle',
              ParamType.String,
            ),
            sectionIndex: params.getParam(
              'sectionIndex',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          ...
          path: CourseDetailsWidget.routePath,
          builder: (context, params) => CourseDetailsWidget(
            courseDoc: params.getParam<CoursesRow>(
              'courseDoc',
              ParamType.SupabaseRow,
            ),
          ),
        ...
        FFRoute(
          name: QuizAndAssessmentWidget.routeName,
          path: QuizAndAssessmentWidget.routePath,
          builder: (context, params) => QuizAndAssessmentWidget(),
        ),
        FFRoute(
          name: UserProfileWidget.routeName,
          path: UserProfileWidget.routePath,
          builder: (context, params) => UserProfileWidget(
            userDoc: params.getParam<UsersRow>(
              'userDoc',
              ParamType.SupabaseRow,
            ),
          ),
        ...
        FFRoute(
          name: SingupWidget.routeName,
          path: SingupWidget.routePath,
          builder: (context, params) => SingupWidget(),
        ),
        FFRoute(
